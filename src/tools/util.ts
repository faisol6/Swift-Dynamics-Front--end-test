export const _isEmpty = (obj: any) => {
  ...
  if (!array) {
    if (type === "string") return obj === "" ? true : false;
    else if (type === "undefined" || type === undefined) return true;
    else if (obj === "null" || obj === null) return true;
    else {
      for (var prop in obj) {
...
export const ChangeUndefineToString = (values: any) => {
  let result = {};
...
export const mockData = [
  ...
  {
    name: "Zambia monsakul",
    gender: "female",
    phone: "0625370527",
    nationality: "Thai",
  },
  {
    name: "Zimbabwe monsakul",
    gender: "female",
    phone: "0625370527",
    nationality: "Thai",
  },
  {
    name: "faisol monsakul",
    gender: "female",
    phone: "0625370527",
    nationality: "Thai",
  },
